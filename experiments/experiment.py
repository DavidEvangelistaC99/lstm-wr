...
data = pd.read_csv("E:/Projects AI/lstm-wr/experiments/MicrosoftStock.csv")
print(data.head())
print(data.info())
print(data.describe())

# Initial data vizualitation

# Open/Close prieces of time
...
# Choose data
prediction = data.loc[(data['date']>datetime(2013,1,1)) &
